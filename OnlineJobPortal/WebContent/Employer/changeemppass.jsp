        ...
        <input type="hidden" name="type" id="type" value="Employer"/>
          <div class="row">
            <div class="form-group col-md-12">
                <label class="col-md-3 control-lable" for="empOldPass"><b>Current Password :</b></label>
                <div class="col-md-9">
                    <input type="password" name="empOldPass" id="empOldPass" class="form-control input-sm" required/>
                </div>
            </div>
         </div>
         <div class="row">
            <div class="form-group col-md-12">
                <label class="col-md-3 control-lable" for="empNewPass"><b>New Password :</b></label>
                <div class="col-md-9">
                    <input type="password" name="empNewPass" id="empNewPass" class="form-control input-sm" required/>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="form-group col-md-12">
                <label class="col-md-3 control-lable" for="empConPass"><b>Confirm New Password :</b></label>
                <div class="col-md-9">
                    <input type="password" name="empConPass" id="empConPass" class="form-control input-sm" required/>
                </div>
            </div>
        </div>
        <div class="row">
...
<script>
var password = document.getElementById("empNewPass");
var confirm_password = document.getElementById("empConPass");
